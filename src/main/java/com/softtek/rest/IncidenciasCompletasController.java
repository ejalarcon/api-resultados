...
public class IncidenciasCompletasController {
	...
	@RequestMapping(value = "/byIdIncidencia", params = { "idIncidencia" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = "/byIdPeticion", params = { "idPeticion" }, method = RequestMethod.GET)
	...
	@RequestMapping(value = "/AllByEstado", params = { "estado" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByTipo", params = { "tipo" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByFechaApertura", params = { "fechaApertura" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByMotivoEstado", params = { "motivoEstado" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByPrioridad", params = { "motivoEstado" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByGrupoAsignado", params = { "grupoAsignado" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByResumen", params = { "resumen" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByUsuarioAsignado", params = { "usuarioAsignado" }, method = RequestMethod.GET)
	@ResponseBody
	public List<IncidenciasCompletas> findAllByUsuarioAsignado(
			@RequestParam("usuarioAsignado") String usuarioAsignado) {
		return incidenciasCompletasRepository.findAllByUsuarioAsignado(usuarioAsignado);
	}

	@RequestMapping(value = "/AllByEntorno", params = { "entorno" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByServicio", params = { "servicio" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByFechaCompromiso", params = { "fechaCompromiso" }, method = RequestMethod.GET)
	@ResponseBody
	public List<IncidenciasCompletas> findAllByFechaCompromiso(
			@RequestParam("fechaCompromiso") String fechaCompromiso) {
		return incidenciasCompletasRepository.findAllByFechaCompromiso(fechaCompromiso);
	}

	@RequestMapping(value = "/AllByCanalEntrada", params = { "canalEntrada" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByEstadoSLM", params = { "estadoSLM" }, method = RequestMethod.GET)
	@ResponseBody
	...
	@RequestMapping(value = "/AllByFechaReapertura", params = { "fechaReapertura" }, method = RequestMethod.GET)
	@ResponseBody
	public List<IncidenciasCompletas> findAllByFechaReapertura(
			@RequestParam("fechaReapertura") String fechaReapertura) {
	...
	// @ResponseBody
	// public List<IncidenciasCompletas>
	// findAllByGrupoAndEstado(@RequestParam("grupo") String grupo,
	// @RequestParam("estado") String estado){
	// return incidenciasCompletasRepository.findAllByGrupoAndEstado(grupo,
	// estado);
	// }

	@RequestMapping(value = "/AllByGrupoAndEstado", params = { "grupoAsignado", "estado" }, method = RequestMethod.GET)
	@ResponseBody
	public List<IncidenciasCompletas> findAllBygrupoAsignadoAndEstado(
			@RequestParam("grupoAsignado") String grupoAsignado, @RequestParam("estado") String estado) {
		return incidenciasCompletasRepository.findAllBygrupoAsignadoAndEstado(grupoAsignado, estado);
	}

	@RequestMapping(value = "/AllByGrupoAndMotivoEstado", params = { "grupoAsignado",
			"motivoEstado" }, method = RequestMethod.GET)
	@ResponseBody
	public List<IncidenciasCompletas> findAllBygrupoAsignadoAndMotivoEstado(
			@RequestParam("grupoAsignado") String grupoAsignado, @RequestParam("motivoEstado") String motivoEstado) {
